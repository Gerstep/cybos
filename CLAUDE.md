...
Cybos uses two repositories:
- **Private** (`origin`): Full repo with all files including deals, calls, research
- **Public** (`cybos`): Filtered repo at https://github.com/Gerstep/cybos - code only, no private data
