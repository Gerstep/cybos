...
- Company research must exist in `/deals/<company>/research/`
- Deal context in `/deals/<company>/.cybos/context.md`
...
- `/deals/<company>/memo/memo.md` (overwrites previous version)
