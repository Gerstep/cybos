...
Generate a comprehensive morning brief consolidating unread Telegram messages, important emails, calendar events, and GTD tasks. Includes AI-generated synthesis and strategic leverage scoring. Output saved to `/content/briefs/`.
...
- Use `mcp__calendar__list-events` (note: hyphen, not underscore):
  ```
  calendarId: "primary"
  timeMin: "YYYY-MM-DDTHH:00:00"
  timeMax: "YYYY-MM-DDTHH:59:59"
...
4. Check `/deals/` folder for matching company context files
...
Save brief to: `/content/briefs/MMDD-YY.md`
...
```
Morning Brief generated: /content/briefs/MMDD-YY.md
...
3. **Deal-related** - Messages from companies in `/deals/`
...
- Brief is persistent (kept in /content/briefs/)
