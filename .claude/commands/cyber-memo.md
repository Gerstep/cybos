...
**Prerequisites**: Company research must exist in /deals/<company>/research/

Execute the DD memo workflow:

1. **GATHER**: Load all research and context
   - All research reports from /deals/<company>/research/
   - Deal context from /deals/<company>/.cybos/context.md
...
5. **OUTPUT**: Save memo to /deals/<company-slug>/memo/memo.md
   - **Overwrites** previous version (living document)

6. **LOG**: Log memo generation to /.cybos/logs/MMDD-<slug>-YY.md
